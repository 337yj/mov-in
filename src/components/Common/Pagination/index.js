...
import {
  IconCaretLeft,
  IconDoubleChevron,
  IconDoubleLeftChevron,
  IconDoubleRightChevron,
} from "../../../assets";
...
const Paging = ({
  ...
  return (
    <Pagination
      ...
      firstPageText={<IconDoubleLeftChevron className={styles.firstPageIcon} />}
      prevPageText={<IconCaretLeft className={styles.icon} />} // 이전 페이지 버튼에 표시될 텍스트
      lastPageText={<IconDoubleRightChevron className={styles.lastPageIcon} />}
